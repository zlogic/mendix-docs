...
When you choose to represent associations as links, the data of associated objects can be included in the response by using the $expand query parameter. See [Retrieving Associated Objects](/refguide9/odata-query-options/#23-retrieving-associated-objects).
