...
**Release date: December ____, 2024**
...
- We fixed an issue where an Oops dialog was displayed when removing a snippet parameter which was used in conditional visibility. 
