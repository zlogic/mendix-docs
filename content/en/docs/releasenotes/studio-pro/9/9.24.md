...
- You can now enable the simplified progress dialog via a menu item. {TW}
...
- We fixed an issue where an **Oops** pop-up window was displayed when opening the **Page Settings** properties dialog for a create action from a menu item. {TW}
