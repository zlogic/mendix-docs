...
* We fixed an issue where the [Atlas UI Resources](https://marketplace.mendix.com/link/component/104730?_gl=1*sfetmy*_gcl_au*MTAxNDY2MDc2Mi4xNzI1ODczNDgw) module could not be imported from the Marketplace.
