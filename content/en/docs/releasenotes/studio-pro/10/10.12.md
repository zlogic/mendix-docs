...
* We optimized data retrieval in [Optimize for Neork Load mode](/refguide/datasource-runtime/#optimize-for-neork-load) even further. Entity paths in expressions now only retrieve the ID attributes of associated objects.
