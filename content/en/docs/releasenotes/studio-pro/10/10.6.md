...
* We fixed an issue in the Dojo client where a microflow using "Close all pages" activity followed by an "Open page" activity would fail to open the page in specific situations after using the browser's back button. (Ticket 229707)
