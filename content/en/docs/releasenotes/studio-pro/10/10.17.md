...
* We fixed an issue which incorrectly raised a conflict if a finished parallel workflow path was removed. This issue was reported as known issue in 10.6.
...
* We fixed an issue where variables and captions disappearred in the microflow editor when using the **Send REST Request (beta)** action. (Ticket 232567)
