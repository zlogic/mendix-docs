...
* We released new CLI command that allows you to see statistics on unit sizes in your app. For more information, see [MPR Analyze Command](/refguide/analyze-mpr/).
