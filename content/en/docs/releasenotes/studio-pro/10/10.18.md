...
- In the logic editors, we fixed panning the canvas with middle mouse button when the mouse if over connection points, error handler icons, resize handles, and bézier curve handles. (Ticket #224031) {TW}
