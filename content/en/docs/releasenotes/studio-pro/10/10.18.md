...
- We made Maia Domain Model Generation, a way to generate Domain models using natural language, enabled by default while it was previously hidden behind a **New Features** setting. It is still, however, in experimental phase. {TW}
- We added a new setting that allows to limit the amount of concurrent working area tabs. {TW}
