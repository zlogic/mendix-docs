...
- [Maia Domain Model Generator](/refguide/domain-model-generator/), a way to generate Domain models using natural language, is now enabled by default while it was previously hidden behind a **New Features** setting. It is still, however, in experimental phase.
