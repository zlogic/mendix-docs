...
* You can now enable the custom deployment strategy directly from the Application Configuration page, accessible within the Namespace Details page. This feature allows for application or configuration updates with minimized downtime in certain scenarios. For further information, refer to the updated [Reduced Downtime Deployment](/developerportal/deploy/private-cloud-reduced-downtime/) page.
