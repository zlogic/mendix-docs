...
* We fixed in issue where users that were promoted to Technical Owner would get an incorrect notification

#### Improvement

* Various UI improvements to offer better insight into registration of services
