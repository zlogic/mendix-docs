...
* `GenAI Commons` module found in the [GenAI For Mendix](https://marketplace.mendix.com/link/component/227931) bundle - This module is a required dependency for the Snowflake Cortex Analyst.
