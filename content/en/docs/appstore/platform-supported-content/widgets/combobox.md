...
* **Selection type** – (in version 2.0 and above) database datasource allows exposing selection, and this selection type determines how other [listen to widget](/refguide/listen-to-grid-source/) datasources perceive the data.
