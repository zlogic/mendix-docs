...
1. Open the ProductOverviewVE_NewEdit page that was generated by *ProductOverviewVE*.
2. Remove the Product ID, Supplier, and Category fields.
3. Double-click the Save button and in the On click field, select **Call a microflow**.
4. In the Microflow, select ACT_UpdateProduct. 
5. Click **OK**.
6. Add a new custom column to the data grid on the Overview page and add an **Edit** button.
7. Link this button to the Product_NewEdit page. 
...
4. Add the following two queries into the OQL editor in each new entity:
