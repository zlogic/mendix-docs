...
For Studio Pro version below 10.14, the portable installer does not include all the tools, such as MprTool, mx, mxbuild, mxuit, or MendixConsoleLog, that come installed with Studio Pro or can be leveraged by Studio Pro. The portable installer only includes the tools that are necessary to be able to build with Studio Pro and run apps locally. 
